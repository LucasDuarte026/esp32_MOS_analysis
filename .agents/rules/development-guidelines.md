# DIRETRIZES GERAIS DO PROJETO (DEVELOPMENT GUIDELINES)
...
Este documento dita as regras obrigatórias de desenvolvimento, arquitetura e convenções técnicas. Qualquer modificação de código ou documentação deve seguir estritamente estas diretrizes.

---

## 1. Regras Obrigatórias de Software (Strict Rules)

### 1.1 Modelo Spec-Driven Bottom-Up (Das Mãos à Cabeça)
Qualquer alteração em funcionalidade ou requisito deve propagar de baixo para cima. A IA deve respeitar a hierarquia de dependência física e de software:
...
A IA deve estar ciente da topologia física de bancada para evitar geração de comandos incoerentes:
